...
<table class="table"
    ...
    <tr>
        ...
        &nbsp;&nbsp;<i>toggle:</i> 'glyphicon-rows-alt icon-rows-alt',<br/>
    ...
    <tr>
        ...
        <td>String</td>
        <td>'rows'</td>
        <td>Key in incoming json containing rows data rows.</td>
    </tr>
    <tr>
        <td>ajax</td>
        <td>data-ajax</td>
    ...
    <tr>
        <td>pageList</td>
        <td>data-page-rows</td>
        <td>Array</td>
        <td>[10, 25, 50, 100]</td>
        <td>When set pagination property, initialize the page size selecting rows. If you include the 'All' option, all the records will be shown in your table.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Boolean</td>
        <td>false</td>
        <td>True to show the columns drop down rows.</td>
    </tr>
    <tr>
        <td>showRefresh</td>
    ...
    <tr>
        ...
        <td>Number</td>
        <td>1</td>
        <td>The minimum number of columns to hide from the columns drop down rows.
        </td>
    </tr>
    <tr>
        <td>idField</td>
